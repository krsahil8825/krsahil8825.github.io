...
export const BRANDING = {
    icons: {
        ...
        sizes: {
            "16x16": "/site/favicon-16x16.png",
            "32x32": "/site/favicon-32x32.png",
            "180x180": "/site/favicon-180x180.png",
            "192x192": "/site/favicon-192x192.png",
        }
    },
    themeColor: "#00f0ff",
} as const;
...
export const SEO = {
    ...
    keywords: [
        ...
        "krsahil8825",
        "krsahil 8825",
        "krsahil8825 developer",
        "krsahil portfolio",
        "kumar sahil portfolio",
        "krsahil.co.in",
        "krsahil website",
        "krsahil developer",
        "krsahil full stack developer",
        "krsahil backend developer",
        "krsahil frontend developer",
